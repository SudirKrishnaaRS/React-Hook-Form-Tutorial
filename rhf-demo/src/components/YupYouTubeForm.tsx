...
export const YupYouTubeForm = () => {
  const form = useForm<FormValues>({
    ...
    /* The line `resolver: yupResolver(schema)` in the `useForm` hook is configuring the form
    validation resolver to use the `yup` schema for validating the form inputs. */
